...
The Capture facility is supported for the RX230, RX231, RX64M, RX71M, RX72M, RX66N, RX72N etc.
Recovery from software standby mode can be performed by an alarm interrupt or 
periodic interrupt. 

Features
--------
* 1-Hz and 64-Hz(RX11x, RX23x, RX64M, RX71M, RX72M, RX66N, RX72N etc.) clock output.
