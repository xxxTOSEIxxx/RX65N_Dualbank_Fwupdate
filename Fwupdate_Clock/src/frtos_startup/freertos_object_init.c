...
void Kernel_Object_init (void)
{
    ...
    ret = xTaskCreate(Task_Usb, "Task_Usb", 512, NULL, 3, NULL);
    if (pdPASS != ret)
    {
        while (1)
        {
    ...
    ret = xTaskCreate(Task_Fwupdate, "Task_Fwupdate", 512, NULL, 3, NULL);
    if (pdPASS != ret)
    {
        while (1)
        {
    ...
    ret = xTaskCreate(Task_Clock, "Task_Clock", 512, NULL, 3, NULL);
    if (pdPASS != ret)
    {
        while (1)
        {
